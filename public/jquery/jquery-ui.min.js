...
!(function (t) {
  ...
  V.widget("ui.droppable", {
    ...
    (V.ui.intersect = function (t, e, i, s) {
      ...
      switch (i) {
        ...
        case "pointer":
          return (
            Y(s.pageY, h, e.proportions().height) &&
            Y(s.pageX, l, e.proportions().width)
          );
        case "touch":
          return (
  ...
  function U() {
    V.datepicker._isDisabledDatepicker(
      (d.inline ? d.dpDiv.parent() : d.input)[0]
    ) ||
      (V(this)
  ...
  V.extend(V.ui, { datepicker: { version: "1.13.3" } }),
    V.extend(q.prototype, {
      ...
      _updateDatepicker: function (t) {
        (this.maxRows = 4),
          (d = t).dpDiv.empty().append(this._generateHTML(t)),
    ...
    return (
      ...
      b(G, function (t, e) {
        ...
        if (i)
          return (
            (i = n[e](i)),
            (n[v[e].cache] = i[v[e].cache]),
            (o = n._rgba = i._rgba),
            !1
          );
      }),
      o.length
        ? ("0,0,0,0" === o.join() && g.extend(o, M.transparent), n)
        : M[s]
    );
  }
  function T(t, e, i) {
  ...
  (t.style.cssText = "background-color:rgba(1,1,1,.5)"),
    (J.rgba = -1 < t.style.backgroundColor.indexOf("rgba")),
    b(v, function (t, e) {
      (e.cache = "_" + t),
            ...
            ? (n instanceof _
                ...
                : b(v, function (t, i) {
                    ...
                    b(i.props, function (t, e) {
                      ...
                      o[s] &&
                        g.inArray(null, o[s].slice(0, 3)) < 0 &&
        ...
        (g.cssHooks[o] = {
          ...
          (g.fx.step[o] = function (t) {
            t.colorInit ||
              ...
              (t.end = _(t.end)),
              (t.colorInit = !0)),
              g.cssHooks[o].set(t.elem, t.start.transition(t.end, t.pos));
          });
      });
    })(
      ...
      V.extend(V.effects, {
        ...
        restore: function (t, e) {
          for (var i, s = 0, n = e.length; s < n; s++)
            null !== e[s] && ((i = t.data(S + e[s])), t.css(e[s], i));
        },
      ...
      show:
        ...
        function (t) {
          return O(t)
            ...
            : (((t = A.apply(this, arguments)).mode = "show"),
      ...
      hide:
        ...
        function (t) {
          return O(t)
            ...
            : (((t = A.apply(this, arguments)).mode = "hide"),
              this.effect.call(this, t));
        }),
      toggle:
        ((at = V.fn.toggle),
        function (t) {
          return O(t) || "boolean" == typeof t
            ? at.apply(this, arguments)
            : (((t = A.apply(this, arguments)).mode = "toggle"),
              this.effect.call(this, t));
        }),
      cssUnit: function (t) {
        var i = this.css(t),
